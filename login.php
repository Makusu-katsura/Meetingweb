...
<head>
    ...
    <style>
        body{
            margin: 0px;
            background-image: url("tower.gif");/*url("bgif1.gif");*/
...
<img src="login5.gif" style="width:50%"><br><br>
    <?php
    ...
    echo "<h3>If you haven't registered => Please contact admin or <a href=\"contact.php\">Click Here</a></h3>";
    ?>
    </div>
    </center>
</body>
